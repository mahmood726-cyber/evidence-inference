"""
Comprehensive NMA Pro v6.2 App Testing
"""
...
def main():
    print("="*70)
    print("NMA PRO v6.2 - COMPREHENSIVE APP TESTING")
    print("="*70)
    ...
    time.sleep(1)
    test_element_exists(driver, "#consistencyTableBody", "Consistency Table")
    ...
    time.sleep(1)
    test_element_exists(driver, "#metaregCovariateSelect", "Covariate Selector")

    print("\n[10] CINeMA TAB")
    switch_tab(driver, "cinema")
    time.sleep(1)
    test_element_exists(driver, "#runCinemaBtn", "CINeMA Button")
    ...
    try:
        ...
        if "100%" in panel.text:
            log("R Validation 100%", "PASS")
