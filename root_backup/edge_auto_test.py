#!/usr/bin/env python3
"""Edge Browser Validation - Using Selenium's built-in driver manager"""
...
print("=" * 70)
print("EDGE BROWSER VALIDATION TEST")
print("TruthCert-PairwisePro - Complete Validation")
print("=" * 70)

# Setup Edge with automatic driver management (Selenium 4.6+)
options = Options()
...
print("\nInitializing Edge browser (auto driver)...")
try:
    driver = webdriver.Edge(options=options)
except Exception as e:
    print(f"Edge failed: {e}")
    print("\nTrying Chrome instead...")
